...
export const zh = {
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'chat.steering.received': '已接收 · 当前步骤结束后发送给模型',
  'chat.steering.parked': '已接收 · 将在智能体下次运行时发送',
...
export const en = {
  ...
  'chat.steering.received': 'Received · sends to the model after the current step',
  'chat.steering.parked': 'Received · sends when the agent next runs',
