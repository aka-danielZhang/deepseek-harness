...
import { getToolbarHosts, subscribeToolbarHosts } from './toolbar-hosts.ts'
...
export function ConversationSessionHeader({
  ...
  const hosts = useSyncExternalStore(subscribeToolbarHosts, getToolbarHosts)
  ...
  if (hosts !== null && !hideChrome) {
    return (
      <header className={clsx(css.header, css.headerPortalled)} aria-hidden={undefined}>
        {createPortal(
          <>
